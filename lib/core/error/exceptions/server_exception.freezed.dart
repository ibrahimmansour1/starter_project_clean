...
class _$UnknownImpl with DiagnosticableTreeMixin implements Unknown {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ServerException.unknown'))
...
class _$InternalErrorImpl
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ServerException.internalError'))
      ..add(DiagnosticsProperty('message', message));
  }
...
class _$ServiceUnavailableImpl
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ServerException.serviceUnavailable'))
      ..add(DiagnosticsProperty('message', message));
  }
